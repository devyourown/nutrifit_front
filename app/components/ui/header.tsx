      ...
      <div className="bg-white py-6">
        <div className="container mx-auto flex flex-col items-center">
          ...
          <Link href="/" className="flex flex-col items-center mb-4">
            ...
            <span className="text-2xl font-bold text-gray-800">Nutrifit</span>
          </Link>
          
          {/* Navigation Links */}
          <nav className="flex space-x-8 text-gray-600 text-sm">
            <Link href="/shop" className="hover:text-gray-800 transition duration-300">
              shop all
            </Link>
            <Link href="/subscription" className="hover:text-gray-800 transition duration-300">
              subscribe
            </Link>
            <Link href="/gift-card" className="hover:text-gray-800 transition duration-300">
              gift card
            </Link>
            <Link href="/story" className="hover:text-gray-800 transition duration-300">
              our story
            </Link>
          </nav>
        </div>
